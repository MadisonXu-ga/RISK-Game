...
public class Constants {
    ...
    public static final int DEFAULT_RESOURCE_NUM = 20;
    public static final int PRODUCE_FOOD_RESOURCE_PER_TURN = 5;
    public static final int PRODUCE_TECH_RESOURCE_PER_TURN = 5;
