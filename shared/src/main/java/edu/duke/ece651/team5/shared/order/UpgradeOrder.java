 ...
 */
public class UpgradeOrder implements Order, Serializable {
    public final static ArrayList<Integer> upgradeConsumeCost = new ArrayList<>(
            Arrays.asList(0, 3, 11, 30, 55, 90, 140));
     ...
     * constructor
     * 
     * @param territoryName    the territory name of the territory where is upgrade
     *                         is about to happen
     * @param soldierToUpgrade soldiers to be upgrade (solider, how many of this
     *                         soldier) -> target level
